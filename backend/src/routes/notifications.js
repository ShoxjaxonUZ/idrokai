...
// Auth: FAQAT httpOnly cookie (EventSource withCredentials bilan yuboradi).
// Query'dagi ?token= qabul qilinmaydi — JWT URL'da log/referer orqali sizib
// ketishi mumkin (xavfsizlik).
